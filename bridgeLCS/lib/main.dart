                                      ...
                                      onPressed: () async {
                                        ...
                                        if (net == true) {
                                          ...
                                          if (loginRes["title"] == "Error") {
                                            ...
                                            apiToken = await prefs
                                                .getString("APIToken");
                                            companyID =
                                                await prefs.getInt("CompanyID");
                                            loginCode =
                                                await prefs.getString("CODE");
                                            userEmail = await prefs
                                                .getString("userEmail");
                                            userName = await prefs
                                                .getString("userName");
  ...
  Widget build(BuildContext context) {
    return Center(
      child: new SplashScreen(
        seconds: 3,
        navigateAfterSeconds: /* loggedIN == 1 ? DashBoardNew() :  MyHomePageEx() */ loggedIN ==
                1
            ? DashBoardNew()
            : (loggedIN == 0
                ? INtroSlides()
        ...
        // imageBackground: ImageProvider.AssetImage(),
