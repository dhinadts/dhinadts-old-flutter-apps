...
var countrySelected = "Ex: India";
bool countryS = false;
bool stateS = false;
bool cityS = false;
var countrySelected1;
var citySelected1;
var stateSelected1;
...
class AddSchoolDetailsReg extends State<AddSchoolDetails> {
  @override
  void initState() {
    super.initState();
  ...
  searchCountry() async {
    ...
    for (int i = 0; i < countrySelection.length; i++) {
      ...
      // ids.add(countrySelection[i]["countryID"]);
      // codes.add(countrySelection[i]['country_code']);
    }
  }
                            ...
                            child: TextField(
                              controller: new TextEditingController.fromValue(
                                    new TextEditingValue(
                                        text: stateC.text,
                                        selection: new TextSelection.collapsed(
                                            offset: stateC.text.length))),
                              keyboardType: TextInputType.text,
                               onChanged: (value) async {
                                  stateC.text = value;
                                  items2.clear();

                                  await searchStateC(value);
                                  setState(() {});
                                },
                              decoration: new InputDecoration(
                                border: InputBorder.none,
