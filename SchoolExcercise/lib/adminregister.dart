...
class AdminRegister extends StatefulWidget {
  ...
  const AdminRegister({Key key, @required this.checkUser}) : super(key: key);
  @override
  AReg createState() {
    return new AReg();
  }
...
class AReg extends State<AdminRegister> {
  @override
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Text("Confirm Mobile Number:",
                                        style: TextStyle(
                                            color: Colors.black, fontSize: 20)),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${mobileNo.text}",
                                        style: TextStyle(
                                            color: Colors.black, fontSize: 20)),
                                  ),
                                  Padding(
