...
class ViewStudyMaterial extends StatefulWidget {
  ViewStudyMaterial({Key key}) : super(key: key);
...
class _ViewStudyMaterialState extends State<ViewStudyMaterial> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("View Study Material")),
        ...
        subjectList == null
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, i) {
                  if(subjectList[i]["statue"] != "Failed") {
...
return Text("No dara");
 ...
 getStudentList(String classID) async {
    ...
    FormData formData = new FormData.fromMap({
      ...
      /* 
      map.put("action", "view_study_material");
        map.put("schoolid", sharedPreference.getString(StudyMaterialViewList.this, "schoolid"));
        map.put("acyid", sharedPreference.getString(StudyMaterialViewList.this, "staff_acyid"));
        map.put("classid", section_spinner.getTag().toString());
        map.put("subjectid", SubjectListData.get(subject_spinner.getSelectedItemPosition()).getSubjectid());
      //  map.put("subjectid", "0");
        map.put("date", "");
       */
